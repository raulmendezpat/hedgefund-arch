...
FULL_FEATURES = "results/ml_features_ml_features_btc_link_bnb_v5.csv"

WINDOWS = [
    {
        "tag": "wf_2024q1_test_2024q2",
...
def main() -> None:
    ...
    for w in WINDOWS:
        ...
        thresholds_path = f"artifacts/{tag}_thresholds_q05.json"
    ...
    out = ROOT / "artifacts/rolling_ensemble_btc_link_bnb_summary.json"
